...
--
-- Table structure for table `airportlink`
--

DROP TABLE IF EXISTS `airportlink`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `airportlink` (
...
--
-- Dumping data for table `airportlink`
--

LOCK TABLES `airportlink` WRITE;
/*!40000 ALTER TABLE `airportlink` DISABLE KEYS */;
/*!40000 ALTER TABLE `airportlink` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `airportlink_cost_station`
--

DROP TABLE IF EXISTS `airportlink_cost_station`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `airportlink_cost_station` (
  `origination` int(10) DEFAULT NULL,
  `destinantion` int(10) DEFAULT NULL,
  `cost` decimal(8,4) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `airportlink_cost_station`
--

LOCK TABLES `airportlink_cost_station` WRITE;
/*!40000 ALTER TABLE `airportlink_cost_station` DISABLE KEYS */;
/*!40000 ALTER TABLE `airportlink_cost_station` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `brt` WRITE;
/*!40000 ALTER TABLE `brt` DISABLE KEYS */;
/*!40000 ALTER TABLE `brt` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `brt_cost_station`
--

DROP TABLE IF EXISTS `brt_cost_station`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `brt_cost_station` (
  `origination` int(10) DEFAULT NULL,
  `destinantion` int(10) DEFAULT NULL,
  `cost` decimal(8,4) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Dumping data for table `brt_cost_station`
--

LOCK TABLES `brt_cost_station` WRITE;
/*!40000 ALTER TABLE `brt_cost_station` DISABLE KEYS */;
/*!40000 ALTER TABLE `brt_cost_station` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `bts` WRITE;
/*!40000 ALTER TABLE `bts` DISABLE KEYS */;
INSERT INTO `bts` VALUES (1,'Chid Lom'),(2,'Siam');
/*!40000 ALTER TABLE `bts` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `bts_cost_station`
--

DROP TABLE IF EXISTS `bts_cost_station`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bts_cost_station` (
  `origination` int(10) DEFAULT NULL,
...
--
-- Dumping data for table `bts_cost_station`
--

LOCK TABLES `bts_cost_station` WRITE;
/*!40000 ALTER TABLE `bts_cost_station` DISABLE KEYS */;
INSERT INTO `bts_cost_station` VALUES (1,2,15.0000),(2,1,15.0000);
/*!40000 ALTER TABLE `bts_cost_station` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `cc_items` VALUES (31,'Pnit01','2',26,20.00,'dasda','',1,'0000-00-00',0);
...
--
-- Table structure for table `mrt_cost_station`
--

DROP TABLE IF EXISTS `mrt_cost_station`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mrt_cost_station` (
  `origination` int(10) DEFAULT NULL,
  `destinantion` int(10) DEFAULT NULL,
  `cost` decimal(8,4) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Dumping data for table `mrt_cost_station`
--

LOCK TABLES `mrt_cost_station` WRITE;
/*!40000 ALTER TABLE `mrt_cost_station` DISABLE KEYS */;
/*!40000 ALTER TABLE `mrt_cost_station` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `object_field_type` VALUES (1,'reference'),(2,'image'),(3,'password'),(4,'text'),(5,'picklist'),(6,'date'),(7,'number');
...
INSERT INTO `services` VALUES (31,'',0);
...
CREATE TABLE `travels` (
  ...
  `travel_sub_type` int(10) NOT NULL,
...
INSERT INTO `travels` VALUES (31,0,0,'',''),(31,0,0,'',''),(33,0,0,'',''),(35,0,0,'','');
...
-- Dump completed on 2017-01-31 20:28:23
